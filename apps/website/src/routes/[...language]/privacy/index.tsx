...
export default component$(() => {
    return (
        <div class="prose">
            ...
            E-Mail-Adresse:
            <p>
                <a href="mailto:rico@hrwg.de">rico@hrwg.de</a>
            </p>
            ...
            <p>
                TLS-Verschlüsselung (https): Um Ihre via unserem Online-Angebot übermittelten Daten
                zu schützen, nutzen wir eine TLS-Verschlüsselung. Sie erkennen derart verschlüsselte
            ...
            <p>
                ...
                Drittländern mit einem anerkannten Datenschutzniveau, vertraglichen Verpflichtung
                durch sogenannte Standardschutzklauseln der EU-Kommission, beim Vorliegen von
                Zertifizierungen oder verbindlicher internen Datenschutzvorschriften verarbeiten
            ...
            <p>
                ...
                auf Endgeräten speichern und Informationen aus den Endgeräten auslesen. Z.B. um den
                ...
                Zwecken der Funktionsfähigkeit, Sicherheit und Komfort von Onlineangeboten sowie der
            ...
            <p>
                ...
                Auf welcher datenschutzrechtlichen Rechtsgrundlage wir die personenbezogenen Daten
                ...
                von Cookies verarbeiteten Daten auf Grundlage unserer berechtigten Interessen (z.B.
                an einem betriebswirtschaftlichen Betrieb unseres Onlineangebotes und Verbesserung
                ...
                unsere vertraglichen Verpflichtungen zu erfüllen. Zu welchen Zwecken die Cookies von
                uns verarbeitet werden, darüber klären wir im Laufe dieser Datenschutzerklärung oder
            ...
            <p>
                ...
                zudem einen Widerspruch gegen die Verarbeitung entsprechend den gesetzlichen
                Vorgaben im Art. 21 DSGVO einlegen. Nutzer können ihren Widerspruch auch über die
                Einstellungen ihres Browsers erklären, z.B. durch Deaktivierung der Verwendung von
                Cookies (wobei dadurch auch die Funktionalität unserer Online-Dienste eingeschränkt
            ...
            <ul class="m-elements">
                <li>
                    ...
                    (auch &quot;Webhoster&quot; genannt) mieten oder anderweitig beziehen;
                    <strong>Rechtsgrundlagen:</strong>
                    Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO).
                </li>
                <li>
            ...
            <p>
                ...
                (nachfolgend &quot;Publikationsmedium&quot;). Die Daten der Leser werden für die
                Zwecke des Publikationsmediums nur insoweit verarbeitet, als es für dessen
                Darstellung und die Kommunikation zwischen Autoren und Lesern oder aus Gründen der
                Sicherheit erforderlich ist. Im Übrigen verweisen wir auf die Informationen zur
            ...
            <ul class="m-elements">
                <li>
                    ...
                    Identität des Verfassers interessiert. Des Weiteren behalten wir uns vor, auf
                    ...
                    speichern und Cookies zu verwenden, um Mehrfachabstimmungen zu vermeiden. Die im
            ...
            <ul class="m-elements">
                <li>
                    <strong>Kontaktformular: </strong>Wenn Nutzer über unser Kontaktformular, E-Mail
                    oder andere Kommunikationswege mit uns in Kontakt treten, verarbeiten wir die
                    uns in diesem Zusammenhang mitgeteilten Daten zur Bearbeitung des mitgeteilten
                    Anliegens;
                    <strong>Rechtsgrundlagen:</strong>
                    Vertragserfüllung und vorvertragliche Anfragen (Art. 6 Abs. 1 S. 1 lit. b)
            ...
            <p>
                ...
                Auswertung der Besucherströme unseres Onlineangebotes und kann Verhalten, Interessen
                oder demographische Informationen zu den Besuchern, wie z.B. das Alter oder das
            ...
            <p>
                ...
                erhobenen Angaben gehören insbesondere besuchte Webseiten und dort genutzte Elemente
                sowie technische Angaben, wie der verwendete Browser, das verwendete Computersystem
                sowie Angaben zu Nutzungszeiten. Sofern Nutzer in die Erhebung ihrer Standortdaten
            ...
            <ul class="m-elements">
                <li>
                    <strong>Google Analytics: </strong>Webanalyse, Reichweitenmessung sowie Messung
                    von Nutzerströmen;
                    ...
                    <div class="font-bold">Datenschutzerklärung:</div>
                    <a
                    ...
                    <div class="font-bold">Auftragsverarbeitungsvertrag:</div>
                    <a
                    ...
                    <div class="font-bold">Widerspruchsmöglichkeit (Opt-Out):</div>
                    <p>Opt-Out-Plugin:</p>
                    <a
                    ...
                    <p>Einstellungen für die Darstellung von Werbeeinblendungen:</p>
                    <a
                    ...
                    <div class="mt-2 font-bold">Weitere Informationen:</div>
                    <a
            ...
            <ul class="m-elements">
                <li>
                    ...
                    Soziales Netzwerk;
                    <div class="font-bold">Dienstanbieter:</div>
                    Meta Platforms Irland Limited, 4 Grand Canal Square, Grand Canal Harbour, Dublin
                    2, Irland;
                    <div class="font-bold">Rechtsgrundlagen:</div>
                    Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO);
                    <div class="font-bold">Website:</div>
                    <a
                ...
                <li>
                    ...
                    Soziales Netzwerk;
                    <div class="font-bold">Dienstanbieter:</div>
                    Twitter International Company, One Cumberland Place, Fenian Street, Dublin 2 D02
                    AX07, Irland, Mutterunternehmen: Twitter Inc., 1355 Market Street, Suite 900,
            ...
            <p>
                ...
                Servern ihrer jeweiligen Anbieter (nachfolgend bezeichnet als
                &quot;Drittanbieter&quot;) bezogen werden. Dabei kann es sich zum Beispiel um
                Grafiken, Videos oder Stadtpläne handeln (nachfolgend einheitlich bezeichnet als
                &quot;Inhalte&quot;).
            </p>
            <p>
            ...
            <ul class="m-elements">
                <li>
                    <div class="font-bold">Google Fonts (Bezug vom Google Server):</div>
                    Bezug von Schriften (und Symbolen) zum Zwecke einer technisch sicheren,
                    wartungsfreien und effizienten Nutzung von Schriften und Symbolen im Hinblick
                    auf Aktualität und Ladezeiten, deren einheitliche Darstellung und
                    Berücksichtigung möglicher lizenzrechtlicher Beschränkungen. Dem Anbieter der
                    Schriftarten wird die IP-Adresse des Nutzers mitgeteilt, damit die Schriftarten
                    im Browser des Nutzers zur Verfügung gestellt werden können. Darüber hinaus
                    werden technische Daten (Spracheinstellungen, Bildschirmauflösung,
                    Betriebssystem, verwendete Hardware) übermittelt, die für die Bereitstellung der
                    Schriften in Abhängigkeit von den verwendeten Geräten und der technischen
                    Umgebung notwendig sind. Diese Daten können auf einem Server des Anbieters der
            ...
            <ul>
                ...
                <li>
                    ...
                    Sie betreffende Daten unverzüglich gelöscht werden, bzw. alternativ nach Maßgabe
            ...
            <ul class="glossary">
                ...
                <li>
                    ...
                    Die Verarbeitung von &quot;Profilen mit nutzerbezogenen Informationen&quot;,
                    bzw. kurz &quot;Profilen&quot; umfasst jede Art der automatisierten Verarbeitung
                    ...
                    Interaktion mit Webseiten und deren Inhalten, etc.) zu analysieren, zu bewerten
                    oder, um sie vorherzusagen (z.B. die Interessen an bestimmten Inhalten oder
                ...
                <li>
                    ...
                    Die Reichweitenmessung (auch als Web Analytics bezeichnet) dient der Auswertung
                    ...
                    erkennen, zu welcher Zeit Besucher ihre Webseite besuchen und für welche Inhalte
                    sie sich interessieren. Dadurch können sie z.B. die Inhalte der Webseite besser
